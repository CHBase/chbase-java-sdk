...
import com.chbase.methods.jaxb.addapplication2.request.AddApplication2Request;
import com.chbase.methods.jaxb.addapplication2.response.AddApplication2Response;
import com.chbase.methods.jaxb.application.AppLargeLogoInfo;
import com.chbase.methods.jaxb.application.CultureSpecificAppLargeLogo;
import com.chbase.methods.jaxb.application.PublicKeys;
import com.chbase.methods.jaxb.auth.Auth;
import com.chbase.methods.jaxb.auth.AuthXml;
import com.chbase.methods.jaxb.auth.Rule;
import com.chbase.methods.jaxb.auth.Rules;
import com.chbase.methods.jaxb.auth.Set;
import com.chbase.thing.oxm.jaxb.types.CultureSpecificString1024;
...
public class AddApplicationTest {
	...
	public void AddApplication() throws Exception {
		SimpleRequestTemplate requestTemplate = new SimpleRequestTemplate(ConnectionFactory.getConnection(MasterAppId));

		AddApplication2Request request = new AddApplication2Request();
		request.getName().add(new CultureSpecificString255("My Application"));
		...
		rule.getReason().add(new CultureSpecificString1024("Required Access"));
		...
		request.getDescription().add(new CultureSpecificStringnz("Test Child App--unit test"));
		request.getAuthReason().add(new CultureSpecificStringnz("Authorization Reason Here"));
		...
		AddApplication2Response response = (AddApplication2Response) requestTemplate.makeRequest(request);
