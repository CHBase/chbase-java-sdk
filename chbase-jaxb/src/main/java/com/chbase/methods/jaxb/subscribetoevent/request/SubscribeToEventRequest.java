...
package com.chbase.methods.jaxb.subscribetoevent.request;
 ...
 * 
 */
@JaxbRequest(methodName = "SubscribeToEvent", methodVersion = "1", responseNS = "urn:com.microsoft.wc.methods.response.SubscribeToEvent")
