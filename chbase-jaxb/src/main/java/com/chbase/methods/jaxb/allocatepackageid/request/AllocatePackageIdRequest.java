...
package com.chbase.methods.jaxb.allocatepackageid.request;
 ...
 * 
 */
@JaxbRequest(methodName = "AllocatePackageId", methodVersion = "1", responseNS = "urn:com.microsoft.wc.methods.response.AllocatePackageId")
